import pytest
from ai_studio.config import resolve_model_path, scan_available_models
...
def test_resolve_recursive_custom_safetensors(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("ai_studio.config.MODEL_SEARCH_PATHS", [tmp_path])
...
def test_get_model_config():
    from ai_studio.config import get_model_config
